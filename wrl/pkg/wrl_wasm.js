import { render } from './snippets/wrl-wasm-1ae62c02a34dbbcc/web/bindings.js';
 ...
 * @param {boolean} shift
 */
export function keydown(ch, shift) {
    wasm.keydown(ch, shift);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wrl_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
